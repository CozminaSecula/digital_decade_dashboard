---
title: "Digital Decade Dashboard"
format:
  dashboard:
    nav-buttons: [github]
    github: https://github.com/CozminaSecula
execute: 
  echo: false
  message: false
  warning: false
...
theme(
  ...
  plot.subtitle = ggtext::element_textbox_simple(size = 20,
                                                   ...
                                                   color = "#646369",
                                                   family = "Georgia"),
  plot.caption = element_markdown(color = "#828282" , size = 13, hjust = 0,
                                  family = 'Georgia'),
...
coord_flip()+
geom_richtext(
  aes(x = 20.5, y = 33, label = "27.3 pp"), 
  family = "Georgia", size = 6, lineheight = 1.2,
  color = "#414040", hjust = 0, vjust = 1.03,
  label.color = NA,
  fill = NA) +
geom_richtext(
  aes(x = 15.5, y = 23.7, label = "16.5 pp"), 
  family = "Georgia", size = 6, lineheight = 1.2,
  color = "#414040", hjust = 0, vjust = 1.03,
  label.color = NA,
  fill = NA) +
...
geom_richtext(
  aes(x = 16.7, y = 28.5, label = "4.8 pp"), 
  family = "Georgia", size = 6, lineheight = 1.2,
  color = "#414040", hjust = 0, vjust = 1.03,
  label.color = NA,
  fill = NA)
...
title_da <- paste0("Enterprises in Hungary, Croatia, and Denmark most use data analytics")
...
geom_richtext(
  ...
  fill = NA) +
annotate(
  "curve", x = 2.7, xend = 2.23, y = 30, yend = 33, curvature = 0.35, 
  angle = 60, color = "grey60", linewidth = .4, 
  arrow = arrow(type = "closed", length = unit(.08, "inches"))
  )
...
plot_ai_cc_da <- ggplot(data = ai_cc_da ) +
    ...
    theme(axis.title.x = element_blank(),
          ...
          line = element_blank(),
          plot.title = element_textbox_simple(size = 21,
                              color = "#414040",
                              face = "bold", 
                              family = "Georgia",
                              margin = margin(12, 0, 12, 0)),
         plot.subtitle = ggtext::element_textbox_simple(size = 18.5,
                                                   vjust = 1,
                                                   margin = margin(0, 0, 12, 0),
                                                   color = "#646369",
                                                   family = "Georgia"),
...
coord_flip()+
geom_richtext(
  aes(x = 10.9, y = 40, label = "+18.7 pp"), 
  family = "Georgia", size = 6, lineheight = 1.2,
  color = "#414040", hjust = 0, vjust = 1.03,
  label.color = NA,
  fill = NA) +
geom_richtext(
  aes(x = 7.9, y = 42, label = "+10.2 pp"), 
  family = "Georgia", size = 6, lineheight = 1.2,
  color = "#414040", hjust = 0, vjust = 1.03,
  label.color = NA,
  fill = NA) +
...
theme( 
  ...
  axis.title.y = element_blank(),
  plot.caption = element_text(hjust = 0, color = "#828282", size= 13),
  plot.caption.position = "plot",
...
The EU aims to empower businesses and people in a human-centered, sustainable, and more prosperous digital future. The Digital Decade is the framework that guides all actions related to digital. The Digital Decade includes the Digital Decade policy programme, the Digital Decade targets, the objectives, the multi-country projects and the Digital Decade rights & principles.

The focus of this project is the Digital Decade targets, which are the measurable goals for each of the four dimensions: 
...
-   To visualize the performance of selected KPIs for each dimension in 2023 compared to 2021.
-   To visualize the progress of EU member states for selected KPIs.
...
-   Enterprises where more than 50% of the persons employed used computers with access to the internet for business purposes;
...
# Digital Business {orientation="columns"}
